...
//-----------------------------------------------------------------
	...
	*/
	function function_generatePurchaseRequisitionData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(10000000, 10, $i);
			$col++;
		}
	...
	*/
	function getPurchaseRequisitionOptions(){
		return "";
	}
