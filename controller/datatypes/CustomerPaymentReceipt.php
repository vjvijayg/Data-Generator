...
//-----------------------------------------------------------------
	...
	*/
	function function_generateCustomerPaymentReceiptData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(1400000001, 10, $i);
			$col++;
		}
	...
	*/
	function getCustomerPaymentReceiptOptions(){
		return "";
	}
