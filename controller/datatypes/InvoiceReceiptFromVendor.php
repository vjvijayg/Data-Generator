...
//-----------------------------------------------------------------
	...
	*/
	function function_generateInvoiceReceiptFromVendorOrderData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(5105600101, 10, $i);
			$col++;
		}
	...
	*/
	function getInvoiceReceiptFromVendorOptions(){
		return "";
	}
