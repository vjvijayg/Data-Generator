...
//-----------------------------------------------------------------
	...
	*/
	function function_generateGoodsReceiptForPurchaseOrderData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(5000000001, 10, $i);
			$col++;
		}
	...
	*/
	function getGoodsReceiptForPurchaseOrderOptions(){
		return "";
	}
