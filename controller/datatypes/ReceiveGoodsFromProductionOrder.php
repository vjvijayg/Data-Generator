...
//-----------------------------------------------------------------
	...
	*/
	function function_generateReceiveGoodsFromProductionOrderData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(5000000011, 10, $i);
			$col++;
		}
	...
	*/
	function getReceiveGoodsFromProductionOrderOptions(){
		return "";
	}
