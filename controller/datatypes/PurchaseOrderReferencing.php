...
//-----------------------------------------------------------------
	...
	*/
	function function_generatePurchaseOrderReferencingData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(4500000001, 10, $i);
			$col++;
		}
	...
	*/
	function getPurchaseOrderReferencingOptions(){
		return "";
	}
