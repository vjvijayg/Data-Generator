...
//-----------------------------------------------------------------
	...
	*/
	function function_generateRequestForQuotationData($numberOfRows, $columnName) {
		...
		for ($i=0; $i < $numberOfRows; $i++) { 
		    ...
		    $resultArr[0][$col] = getNumber(6000000000, 10, $i);
			$col++;
		}
	...
	*/
	function getRequestForQuotationOptions(){
		return "";
	}
